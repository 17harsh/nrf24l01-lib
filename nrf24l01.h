...
void rx_add(){					
	...
	Address[3] = (unsigned char) ((0x00FF000000 & Data_Pipe1)>>24);
	Address[4] = (unsigned char) ((0xFF00000000 & Data_Pipe1)>>32);
	write_nrf(RX_ADDR_P2,Address,Byte_size);
	...
	Address[3] = (unsigned char) ((0x00FF000000 & Data_Pipe1)>>24);
	Address[4] = (unsigned char) ((0xFF00000000 & Data_Pipe1)>>32);
	write_nrf(RX_ADDR_P3,Address,Byte_size);
	...
	Address[3] = (unsigned char) ((0x00FF000000 & Data_Pipe1)>>24);
	Address[4] = (unsigned char) ((0xFF00000000 & Data_Pipe1)>>32);
	write_nrf(RX_ADDR_P4,Address,Byte_size);
	...
	Address[3] = (unsigned char) ((0x00FF000000 & Data_Pipe1)>>24);
	Address[4] = (unsigned char) ((0xFF00000000 & Data_Pipe1)>>32);
	write_nrf(RX_ADDR_P5,Address,Byte_size);
}
void tx_add(){
	unsigned char Byte_size;
	if (AW == 1) Byte_size = 3;
...
unsigned char *read_nrf(unsigned char Register, unsigned char Byte_size){
	_delay_us(1);
	if(Register <= 0x1D){
